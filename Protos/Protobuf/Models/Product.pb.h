...
PROTOBUF_NAMESPACE_OPEN
template<> ::GrpcProject::Protos::Models::ListProductResponse* Arena::CreateMaybeMessage<::GrpcProject::Protos::Models::ListProductResponse>(Arena*);
template<> ::GrpcProject::Protos::Models::Product* Arena::CreateMaybeMessage<::GrpcProject::Protos::Models::Product>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace GrpcProject {
namespace Protos {
namespace Models {
...
class Product final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GrpcProject.Protos.Models.Product) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GrpcProject.Protos.Models.Product";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:GrpcProject.Protos.Models.Product)
 private:
  class _Internal;
...
class ListProductResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GrpcProject.Protos.Models.ListProductResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GrpcProject.Protos.Models.ListProductResponse";
  }
  protected:
  ...
  public:
  void clear_product();
  ::GrpcProject::Protos::Models::Product* mutable_product(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::GrpcProject::Protos::Models::Product >*
      mutable_product();
  private:
  const ::GrpcProject::Protos::Models::Product& _internal_product(int index) const;
  ::GrpcProject::Protos::Models::Product* _internal_add_product();
  public:
  const ::GrpcProject::Protos::Models::Product& product(int index) const;
  ::GrpcProject::Protos::Models::Product* add_product();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::GrpcProject::Protos::Models::Product >&
      product() const;

  // @@protoc_insertion_point(class_scope:GrpcProject.Protos.Models.ListProductResponse)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::GrpcProject::Protos::Models::Product > product_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_Models_2fProduct_2eproto;
...
inline uint64_t Product::id() const {
  // @@protoc_insertion_point(field_get:GrpcProject.Protos.Models.Product.id)
  return _internal_id();
}
...
inline void Product::set_id(uint64_t value) {
  ...
  // @@protoc_insertion_point(field_set:GrpcProject.Protos.Models.Product.id)
}
...
inline const std::string& Product::name() const {
  // @@protoc_insertion_point(field_get:GrpcProject.Protos.Models.Product.name)
...
void Product::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GrpcProject.Protos.Models.Product.name)
}
inline std::string* Product::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:GrpcProject.Protos.Models.Product.name)
  return _s;
}
...
inline std::string* Product::release_name() {
  // @@protoc_insertion_point(field_release:GrpcProject.Protos.Models.Product.name)
...
inline void Product::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:GrpcProject.Protos.Models.Product.name)
}
...
inline double Product::price() const {
  // @@protoc_insertion_point(field_get:GrpcProject.Protos.Models.Product.price)
...
inline void Product::set_price(double value) {
  ...
  // @@protoc_insertion_point(field_set:GrpcProject.Protos.Models.Product.price)
}
...
// repeated .GrpcProject.Protos.Models.Product product = 1;
inline int ListProductResponse::_internal_product_size() const {
  return _impl_.product_.size();
}
inline int ListProductResponse::product_size() const {
  return _internal_product_size();
}
inline void ListProductResponse::clear_product() {
  _impl_.product_.Clear();
}
inline ::GrpcProject::Protos::Models::Product* ListProductResponse::mutable_product(int index) {
  // @@protoc_insertion_point(field_mutable:GrpcProject.Protos.Models.ListProductResponse.product)
  return _impl_.product_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::GrpcProject::Protos::Models::Product >*
ListProductResponse::mutable_product() {
  // @@protoc_insertion_point(field_mutable_list:GrpcProject.Protos.Models.ListProductResponse.product)
  return &_impl_.product_;
}
inline const ::GrpcProject::Protos::Models::Product& ListProductResponse::_internal_product(int index) const {
  return _impl_.product_.Get(index);
}
inline const ::GrpcProject::Protos::Models::Product& ListProductResponse::product(int index) const {
  // @@protoc_insertion_point(field_get:GrpcProject.Protos.Models.ListProductResponse.product)
  return _internal_product(index);
}
inline ::GrpcProject::Protos::Models::Product* ListProductResponse::_internal_add_product() {
  return _impl_.product_.Add();
}
inline ::GrpcProject::Protos::Models::Product* ListProductResponse::add_product() {
  ::GrpcProject::Protos::Models::Product* _add = _internal_add_product();
  // @@protoc_insertion_point(field_add:GrpcProject.Protos.Models.ListProductResponse.product)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::GrpcProject::Protos::Models::Product >&
ListProductResponse::product() const {
  // @@protoc_insertion_point(field_list:GrpcProject.Protos.Models.ListProductResponse.product)
  return _impl_.product_;
}
